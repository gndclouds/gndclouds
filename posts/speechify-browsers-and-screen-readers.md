...
&nbsp;
![browser-edge-text-to-speech](/img/speechify/browser-edge-text-to-speech.png)
&nbsp;
...
&nbsp;
![safari-text-to-speech](/img/speechify/browser-safari-text-to-speech.png)
&nbsp;
...
&nbsp;
![firefox-text-to-speech](/img/speechify/browser-firefox-text-to-speech.png)
&nbsp;
...
&nbsp;
![browser-extension-arena](/img/speechify/browser-extension-arena.png)
&nbsp;

### Notion

&nbsp;
![browser-extension-notion](/img/speechify/browser-extension-notion.png)
&nbsp;

### Feedly

&nbsp;
![browser-extension-feedly](/img/speechify/browser-extension-feedly.png)
&nbsp;
...
&nbsp;
![browser-extension-evernote](/img/speechify/browser-extension-evernote.png)
&nbsp;
...
&nbsp;
![extension-hypothesis](/img/speechify/browser-extension-hypothesis.png)
&nbsp;
...
&nbsp;
![interface-example-kinopio](/img/speechify/interface-example-kinopio.png)
&nbsp;
...
&nbsp;
![plugin or app feature](/img/speechify/69935E8D-4E88-4695-8588-A62D4DD1A5A4.png)
&nbsp;
Additional Layouts
...
&nbsp;
![mini-player](/img/speechify/33378D1D-6C57-417D-B380-64B1611E46EC.png)
&nbsp;
And you would have the option to click them ➕or use a shortcut to save articles directly to the library in the web app ⤵
&nbsp;
![web app](/img/speechify/C74014E1-A877-4161-A309-09119D7337E4.png)
&nbsp;

A mini-player could be a nice way to show the current text⤵
&nbsp;
![mini-player](/img/speechify/394B2A4B-5FBC-453C-9290-2725A8C3F609.png)
